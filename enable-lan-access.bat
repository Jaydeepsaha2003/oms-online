...
REM  web (6173) and API (4000) dev servers.
REM ============================================================
...
echo Opening firewall ports for OMS dev servers...
echo.
...
echo.
echo (Security note: these rules allow inbound on ports 4000/6173. The app
