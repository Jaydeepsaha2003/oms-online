...
const Input = React.forwardRef<HTMLInputElement, React.ComponentProps<'input'>>(
  ({ className, type, inputMode, ...props }, ref) => {
    // Numeric fields get the mobile numeric keypad by default (decimal so rates,
    // weights etc. can include a point). Callers can still override inputMode.
